<template>
  <div class="antialiased bg-white dark:bg-gray-900">
    <main class="p-4 md:ml-64 h-auto pt-20">
      <div class="p-5">
        <p class="font-bold md:text-3xl">Quản lý thu nhập</p>
      </div>

      <div class="mt-5 h-[300px] bg-background md:p-3">
        <Bar :data="data" :options="options" />
      </div>
      <section class="bg-white-50 dark:bg-gray-900 pt-10">
        <div class="with-full">
          <!-- Start coding here -->
          <div
          ...
          >
            ...
            <div class="overflow-x-auto">
              ...
              >
                ...
                >
                  <tr>
                    <th scope="col" class="px-4 py-3">Mã hoá đơn</th>
                    <th scope="col" class="px-4 py-3">Email</th>
                    <th scope="col" class="px-4 py-3">Số điện thoại</th>
                    <th scope="col" class="px-4 py-3">Địa chỉ</th>
                    <th scope="col" class="px-4 py-3">Chưa biết thêm gì</th>
                        ...
                        >
                          ...
                          <li>
                            <a
                              href="#"
                              type="button"
                              id="buttonUpdateExpence"
                              data-modal-toggle="updateExpence"
                              class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                            >
                              Chỉnh sửa
                            </a>
