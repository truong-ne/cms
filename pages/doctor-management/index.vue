<template>
  <div class="antialiased bg-white dark:bg-gray-900">
    <main class="md:ml-64 h-auto pt-20">
      <div class="p-5"><p class="font-bold md:text-3xl">Quản lý bác sĩ</p></div>
              ...
              >
                ...
                >
                  <tr>
                    ...
                    <th scope="col" class="px-4 py-3">Lương</th>
                        ...
                        >
                          ...
                          <li>
                            <a
                              ...
                              type="button"
                              id="buttonUpdateDoctor"
                              data-modal-toggle="udpateDoctor"
                              class="block py-2 px-4 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white"
                              >Chỉnh sửa</a
                            >
                          </li>
