...
const data = ref("");
onMounted(async () => {
  searchData.value = await search("", { sort: ["ratings:desc"], hitsPerPage: 1000 });
});
      ...
      <div class="bg-blue-600">
          ...
          <div class="w-full">
            <form class="flex items-center">
              ...
              <div class="relative w-full">
                ...
                <input type="text" id="simple-search" v-model="input" @input="meilisearch"
        ...
        <div class="overflow-x-auto">
          ...
          <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tbody>
              <tr class="border-b dark:border-gray-700" v-for="product in searchData">
                ...
                <td class="px-4 py-3 flex items-center justify-end">
                  <button :id="'benq-ex2710q-dropdown-button' + product.id" @click="test(product.id)"
