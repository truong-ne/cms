        ...
        <form action="#" @submit.prevent="onSubmit">
          ...
          <div class="w-full flex items-center justify-center">
            <button
              ...
              class="flex items-center justify-center text-white bg-blue-500 font-medium rounded-lg text-sm px-4 py-2"
            >
...
const onSubmit = handleSubmit(async (values: any) => {
  ...
  if (expirationTime.value == undefined || expirationTime.value == "") {
    message.value = "Vui lòng chọn ngày phát hành";
...
onMounted(() => {
  const expirationTimeDT = document.getElementById("expirationTime");
