...
onUpdated(() => {
  if (currentId.value != blogStore.blog._id) {
    currentId.value = blogStore.blog._id;
    setFieldValue("title", blogStore.blog.title);
    setFieldValue("content", blogStore.blog.content);
  }
});
