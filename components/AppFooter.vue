<template>
  <footer class="p-4 bg-white md:p-8 lg:p-10 dark:bg-gray-800 border-t-4">
    <div class="mx-auto max-w-screen-xl text-center">
      ...
      >
        ...
        />
        <span
          class="self-center text-2xl font-semibold whitespace-nowrap dark:text-white max-sm:text-sm"
          >HealthLine</span
        >
      </a>
      <!-- <svg
      ...
      <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400"
        >© 2021-2022 <a href="#" class="hover:underline">Healthline™</a>. All
