                            ...
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" class="px-4 py-3">Consultation</th>
                                ...
                                <tbody v-for="doctor in doctors">
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            class="flex items-center px-4 py-3 font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <img class="w-8 h-8 rounded-full" :src="doctor.image" alt="Neil image">
                                            <span class="ml-2">{{ doctor.name }}</span>
                                        </th>
                                        <td class="px-4 py-3">{{ doctor.specialty }}</td>
                                        <td class="px-4 py-3">{{ doctor.consultation }}</td>
                                        <td class="px-4 py-3">{{ doctor.joined }}</td>
                                        <td class="px-4 py-3">{{ doctor.price }}</td>
                                        <td class="px-4 py-3">{{ doctor.patient }}</td>
                                        <td class="px-4 py-3">{{ doctor.rating }}</td>
