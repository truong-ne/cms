<template>
    <div id="default-tab-content">
        <div class="grid-cols-4 gap-4 grid p-4 rounded-lg bg-gray-50 dark:bg-gray-800" id="profile" role="tabpanel"
            ...
            <div class="col-span-1 w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700"
                ...
                <div class="flex flex-col items-center pb-10">
                    <img class="w-20 h-20 mb-3 rounded-full shadow-lg" :src="doctors[0].image" alt="Bonnie image" />
            ...
            <section class="bg-gray-50 dark:bg-gray-900">
                <div class="mx-auto max-w-screen-xl">
                    ...
                    <div class="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden">
                        ...
                        <div class="overflow-x-auto py-40 text-center" v-if="isLoading">
                            <div role="status">
                                <svg aria-hidden="true" class="inline w-12 h-12 mr-2 text-gray-200 animate-spin dark:text-gray-600 fill-gray-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div v-if="isLoading === false" class="overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                ...
                                <tbody v-for="medical in dataMedicalRecord.medicals">
                                    <tr class="border-b dark:border-gray-700">
                                        <th scope="row"
                                            class="flex items-center px-4 py-3 font-normal text-gray-900 whitespace-nowrap dark:text-white">
                                            <CldImage height="32" width="32" class="w-8 h-8 rounded-full" :src="medical.avatar" v-if="medical.avatar !== 'default'" alt="Neil image" />
                                            <img class="w-8 h-8 rounded-full" src="/sbcf-default-avatar.png" v-if="medical.avatar === 'default'" alt="Neil image" />
                                            <span class="ml-2">{{ medical.full_name }}</span>
                                        </th>
                                        <td class="px-4 py-3">{{ medical.gender }}</td>
                                        <td class="px-4 py-3">{{ medical.relationship !== "" ?  medical.relationship : "Main Profile"}}</td>
                                        <td class="px-4 py-3">{{ medical.address }}</td>
                        ...
                        <nav v-if="isLoading === false" class="flex flex-col md:flex-row justify-between items-start md:items-center space-y-3 md:space-y-0 p-4"
