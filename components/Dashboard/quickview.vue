<template>
  <div class="grid lg:grid-cols-3 md:gap-4 gap-2 md:mb-4 mb-2">
    ...
    <div class="col-span-1 w-full max-w-md p-4 bg-white border rounded-xl">
      ...
      <div class="flow-root border-t pl-4 pt-4">
        <ol
        ...
        >
          <li class="mb-10 ml-8">
            ...
            >
              ...
              />
              <span
                class="absolute bottom-0 left-5 transform translate-y-1/4 w-3.5 h-3.5 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full"
              ></span>
            </span>
